  ...
  const offices: Office[] = [
    {
      ...
      address:
        "10th Floor, Sheikh Sultan Trust Building, Beaumont Road, Karachi",
    ...
    },
    {
      ...
      name: "Lahore Office",
      address:
        "Office no E9C/2, 9th Floor,Grand Square Mall, Gulberg III Lahore",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Get in touch with our maritime experts across Pakistan. We're here
              to help with all your shipping and logistics needs.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              >
                ...
                <p className="text-blue-100 text-sm">
                  Offices across Pakistan's major cities
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-blue-100 text-sm">
                  Worldwide shipping connections
                </p>
              </motion.div>
            </div>
          </motion.div>
                      ...
                      >
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            const bgDiv = parent?.querySelector(
                              'div[style*="backgroundImage"]'
                            ) as HTMLElement;
                            if (bgDiv) {
                              bgDiv.style.backgroundImage =
                                "url('/images/port-image.jpg')";
                            }
                          }}
                        />
                      </a>
