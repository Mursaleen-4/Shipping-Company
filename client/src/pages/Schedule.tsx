...
import { ChevronDown, ChevronUp, Ship, Clock, MapPin, Calendar } from 'lucide-react';
        ...
        <div className="mb-8 bg-white p-6 rounded-xl shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex-1">
              <label htmlFor="search" className="sr-only">Search vessels</label>
            ...
            <div className="flex items-center space-x-4">
              <div>
                <label htmlFor="vessel-type" className="sr-only">Vessel Type</label>
                <select
                  id="vessel-type"
              ...
              >
                <svg className="-ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 11-2 0V4H5v2a1 1 0 01-2 0V3zm2 7a1 1 0 011-1h6a1 1 0 110 2H6a1 1 0 01-1-1zm4 4a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                </svg>
                Filter
              </button>
            </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500">{vessel.type} • {vessel.capacity}</div>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <div className="text-sm text-gray-500 mr-4">
                        <span className="font-medium">Current Location:</span> {vessel.currentLocation}
                      </div>
                      ...
                      {vessel.voyages.map((voyage) => (
                        <div key={voyage.id} className="mb-8">
                          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                            <div>
                              <h3 className="text-lg font-medium text-gray-900">Voyage: {voyage.voyageNumber}</h3>
                              <div className="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                                ...
                                <div className="mt-2 flex items-center text-sm text-gray-500">
                                  ...
                                  {new Date(voyage.departure).toLocaleDateString()} - {new Date(voyage.arrival).toLocaleDateString()}
                                </div>
                          ...
                          {/* Schedule Timeline */}
                          <div className="mt-6">
                            <h4 className="text-sm font-medium text-gray-500 mb-4">PORT SCHEDULE</h4>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                  <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Arrival (Local)</th>
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Departure (Local)</th>
                                    ...
                                    <tr key={index} className="hover:bg-gray-50">
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                          ...
                                          <div className="ml-4">
                                            <div className="text-sm font-medium text-gray-900">{stop.port}</div>
                                          </div>
                                        </div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">
                                          {new Date(stop.arrival).toLocaleString()}
                                        </div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">
                                          {new Date(stop.departure).toLocaleString()}
                                        </div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        <nav className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6 mt-8" aria-label="Pagination">
          <div className="hidden sm:block">
            <p className="text-sm text-gray-700">
              Showing <span className="font-medium">1</span> to <span className="font-medium">3</span> of <span className="font-medium">12</span> vessels
            </p>
          </div>
